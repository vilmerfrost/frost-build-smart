    ...
    <section className="relative min-h-[85vh] pt-24 pb-16 md:pt-32 md:pb-24">
      <div className="section-container">
        <div className="max-w-3xl">
          ...
          {/* Main headline - Bygglet inspired */}
          ...
          {/* Feature list */}
          <div className="animate-fade-in-up stagger-2 mt-8 flex flex-wrap gap-x-8 gap-y-2">
          ...
          {/* Testimonial quote */}
          <div className="animate-fade-in-up stagger-4 mt-12 rounded-xl border border-border bg-card p-5">
            <p className="text-base font-medium text-accent">
              "Utan Frost Bygg skulle jag hellre lasta grönsaker på ICA"
            </p>
            <div className="mt-3 flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground">
                Johan på Anderssons Bygg bytte till Frost Bygg
              </span>
            </div>
          </div>

          {/* Trust badges */}
          <div className="animate-fade-in-up stagger-5 mt-8 flex flex-wrap items-center gap-6 text-sm text-muted-foreground">
