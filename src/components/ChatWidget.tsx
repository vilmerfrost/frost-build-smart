...
const BOT_RESPONSES: Record<string, string> = {
  ...
  'vad kostar det?': 'Vi har en enkel prissättning: 499 kr/månad med obegränsat antal användare! Du får 14 dagars gratis trial - ingen bindningstid. 💰',
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={`fixed bottom-6 right-6 z-50 p-4 rounded-full bg-primary text-foreground shadow-lg transition-all ${
          isOpen ? 'scale-0 opacity-0' : 'scale-100 opacity-100'
        }`}
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
        style={{
          boxShadow: '0 4px 20px hsl(18 100% 55% / 0.35)',
        }}
                ...
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-2 bg-primary text-foreground rounded-lg hover:bg-primary/90 transition-colors"
                    >
            ...
            <div className="p-4 border-t border-border bg-card">
              ...
              >
                ...
                <button
                  ...
                  className="p-2.5 bg-primary text-foreground rounded-xl hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
